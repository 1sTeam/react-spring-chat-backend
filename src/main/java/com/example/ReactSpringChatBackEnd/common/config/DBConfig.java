...
@EnableJpaRepositories(
        basePackages = "com.example.ReactSpringChatBackEnd.auth.repository", // TODO Repository 패키지 지정
...
public class DBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        return builder.dataSource(dataSource)
                .packages("com.example.ReactSpringChatBackEnd.auth.domain") // TODO Model 패키지 지정
                .properties(map)
                .build();
    }
